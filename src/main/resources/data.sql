...
-- INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W5'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wood'), '2019-01-02');
-- INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2019-02-01');
--
