...
-- INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wood'), '2019-01-01');
...
-- VALUES (
--
--  (SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C1'),
--  (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wood'),
--   '2017-01-02');
--
--
--
